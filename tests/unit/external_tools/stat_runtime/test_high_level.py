...
class TestNewSchemas:
    ...
    def test_analysis_mode_enum(self):
        from lazybridge.external_tools.stat_runtime.schemas import AnalysisMode
    ...
    def test_column_signals(self):
        from lazybridge.external_tools.stat_runtime.schemas import ColumnSignals
...
class TestGenerateDatasetSummary:
    def test_basic_summary(self):
        from lazybridge.external_tools.stat_runtime.inference import generate_dataset_summary
...
class TestResolveAnalysisMode:
    def test_forecast_mode(self):
        from lazybridge.external_tools.stat_runtime.inference import resolve_analysis_mode
