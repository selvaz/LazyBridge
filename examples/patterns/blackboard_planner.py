...
Less precise than :func:`plan_tool.make_planner` (no native parallel, no
structural validation) but easier to prompt and very flexible — the LLM
revises freely by calling ``set_plan`` again.
"""
