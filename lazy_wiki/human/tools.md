...
|---|---|---|
| `lazybridge.ext.doc_skills` | Index local docs with BM25, query from any agent | None |
| `lazybridge.ext.read_docs` | Read .txt .md .pdf .docx .html from file or folder | `lazybridge[tools]` |
