...
from lazybridge.external_tools.stat_runtime.schemas import ForecastResult, RunRecord
...
def _get_plt():
    from lazybridge.external_tools.stat_runtime._deps import require_matplotlib
...
def plot_acf_pacf(
    ...
    *,
    ...
    plt = _get_plt()
    from lazybridge.external_tools.stat_runtime._deps import require_statsmodels
