...
Usage::
    ...
    from lazybridge.external_tools.stat_runtime.runner import StatRuntime
    from lazybridge.external_tools.stat_runtime.tools import stat_tools
...
from lazybridge.external_tools.stat_runtime.schemas import ModelFamily
...
def stat_tools(runtime, level: str = "all") -> list[Tool]:
    ...
    def discover_data() -> dict[str, Any]:
        ...
        """
        try:
            from lazybridge.external_tools.stat_runtime.inference import (
    ...
    def fit_model(
        ...
        """
        try:
            from lazybridge.external_tools.stat_runtime.schemas import ModelSpec
    ...
    def run_diagnostics(
        ...
        try:
            ...
            from lazybridge.external_tools.stat_runtime.diagnostics import adf_test, kpss_test
    ...
    def compare_models(
        ...
        try:
            from lazybridge.external_tools.stat_runtime.diagnostics import compare_models as _compare
...
def stat_agent(
    ...
    **expert_mode=False**:
    ...
    if include_downloader:
        try:
            from lazybridge.external_tools.data_downloader.downloader import DataDownloader
            from lazybridge.external_tools.data_downloader.ticker_db import TickerDatabase
            from lazybridge.external_tools.data_downloader.tools import downloader_tools
