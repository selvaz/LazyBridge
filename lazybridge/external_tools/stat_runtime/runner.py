...
from lazybridge.external_tools.stat_runtime.artifact_store import ArtifactStore
from lazybridge.external_tools.stat_runtime.catalog import DatasetCatalog
from lazybridge.external_tools.stat_runtime.engines import get_engine
from lazybridge.external_tools.stat_runtime.persistence import MetaStore
...
class StatRuntime:
    ...
    def _generate_plots(
        ...
        from lazybridge.external_tools.stat_runtime import plots
...
def _import_polars():
    from lazybridge.external_tools.stat_runtime._deps import require_polars
