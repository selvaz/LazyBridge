...
from lazybridge.external_tools.report_builder._deps import require_bleach, require_jinja2, require_markdown
...
def load_theme_css(theme: str) -> str:
    ...
    pkg = _resource_files("lazybridge.external_tools.report_builder.themes")
...
def build_html_document_jinja2(
    ...
    pkg = _resource_files("lazybridge.external_tools.report_builder.templates")
