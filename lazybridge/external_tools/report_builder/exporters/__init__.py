...
from lazybridge.external_tools.report_builder.quarto.detect import find_quarto
...
def resolve_exporter(
    *,
    ...
    """
    from lazybridge.external_tools.report_builder.exporters.quarto import QuartoExporter
    from lazybridge.external_tools.report_builder.exporters.weasyprint import WeasyPrintExporter
