...
class WeasyPrintExporter(Exporter):
    ...
    def _render_body(self, report: AssembledReport) -> str:
        from lazybridge.external_tools.report_builder.renderer import markdown_to_clean_html
    ...
    def _export_docx(self, report: AssembledReport, output_dir: Path) -> Path:
        from lazybridge.external_tools.report_builder._deps import require_pypandoc
