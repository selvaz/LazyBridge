...
``import lazybridge.external_tools.report_builder`` never triggers these imports —
they fire only when the tool is actually called.

Usage inside other report_builder modules::

    from lazybridge.external_tools.report_builder._deps import require_markdown, require_bleach
"""
