...
if TYPE_CHECKING:
    from lazybridge.external_tools.report_builder.assemblers import AssembledReport, Assembler
...
class FragmentBus:
    ...
    def __init__(
        ...
        *,
        ...
        if assembler is None:
            from lazybridge.external_tools.report_builder.assemblers import BlackboardAssembler
    ...
    def export(
        ...
        *,
        ...
        produced artifact.
        """
        from lazybridge.external_tools.report_builder.exporters import resolve_exporter
