...
### `Agent(engine_or_model: 'str | Any' = 'claude-opus-4-7', tools: 'list[Tool | Callable | Agent] | None' = None, output: 'type' = <class 'str'>, memory: 'Any | None' = None, sources: 'list[Any] | None' = None, guard: 'Any | None' = None, verify: 'Agent | None' = None, max_verify: 'int' = 3, name: 'str | None' = <object object at 0x7faa506c0f30>, description: 'str | None' = <object object at 0x7faa506c0f30>, session: 'Any | None' = <object object at 0x7faa506c0f30>, verbose: 'bool' = <object object at 0x7faa506c0f30>, model: 'str | None' = None, engine: 'Any | None' = None, native_tools: 'list[Any] | None' = None, runtime: 'AgentRuntimeConfig | None' = None, resilience: 'ResilienceConfig | None' = None, observability: 'ObservabilityConfig | None' = None, output_validator: 'Callable[[Any], Any] | None' = <object object at 0x7faa506c0f30>, max_output_retries: 'int' = <object object at 0x7faa506c0f30>, timeout: 'float | None' = <object object at 0x7faa506c0f30>, max_retries: 'int' = <object object at 0x7faa506c0f30>, retry_delay: 'float' = <object object at 0x7faa506c0f30>, fallback: "'Agent | None'" = <object object at 0x7faa506c0f30>, cache: 'bool | Any' = <object object at 0x7faa506c0f30>) -> 'None'`
