...
is lazy-imported.  ``import lazybridge.ext.stat_runtime`` never triggers these
...
def require_duckdb():
    ...
    try:
        ...
        raise ImportError(
            f"duckdb is required for this feature. Run: {_INSTALL_HINT}"
        ) from None
...
def require_polars():
    ...
    try:
        ...
        raise ImportError(
            f"polars is required for this feature. Run: {_INSTALL_HINT}"
        ) from None
...
def require_sqlglot():
    ...
    try:
        ...
        raise ImportError(
            f"sqlglot is required for this feature. Run: {_INSTALL_HINT}"
        ) from None
...
def require_statsmodels():
    ...
    try:
        ...
        raise ImportError(
            f"statsmodels is required for this feature. Run: {_INSTALL_HINT}"
        ) from None
...
def require_arch():
    ...
    try:
        ...
        raise ImportError(
            f"arch is required for this feature. Run: {_INSTALL_HINT}"
        ) from None
...
def require_matplotlib():
    ...
    try:
        ...
        raise ImportError(
            f"matplotlib is required for this feature. Run: {_INSTALL_HINT}"
        ) from None
...
STATS_AVAILABLE: bool = all(
    is_available(m) for m in ("duckdb", "polars", "sqlglot", "statsmodels", "arch")
)
