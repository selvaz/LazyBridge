...
anthropic_search = Agent(engine=LLMEngine("deepseek-flash"), tools=[search_anthropic], name="search_a")
openai_search = Agent(engine=LLMEngine("deepseek-flash"), tools=[search_openai], name="search_o")
google_search = Agent(engine=LLMEngine("deepseek-flash"), tools=[search_google], name="search_g")
synthesiser = Agent(engine=LLMEngine("deepseek-flash"), name="synth")
